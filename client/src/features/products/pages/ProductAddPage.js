...
class ProductAddPage extends BasePage {
    ...
    renderContent() {
        ...
        const microsMineralsFields = [
            ...
            { name: 'sodium', label: 'Sodium (g)', type: 'number', numberConfig: { min: 0, max: 999, step: 0.1 } },
            { name: 'calcium', label: 'Calcium (mg)', type: 'number', numberConfig: { min: 0, max: 9999, step: 0.1 } },
